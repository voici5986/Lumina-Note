...
> 🚀 **このプロジェクトは、1人が AI 支援開発で 10 日間で構築しました。47,000 行以上のソースコードを含みます**
...
- [ ] **バックリンクパネル**：現在のノートを参照しているノートを表示
- [ ] **タグ集約**：タグをクリックしてナビゲート、タグ管理ページ
- [ ] **テンプレートシステム**：新規ノート作成時にテンプレートを選択
- [ ] **エクスポート**：PDF / HTML / Word へのエクスポート
- [ ] **プラグインシステム**：プラグイン API 設計
- [ ] **同期**：WebDAV / Git 同期サポート
- [ ] **モバイル**：iOS / Android 対応
