...
export const basicTestCases: TestCase[] = [
  ...
  // 编辑类
  {
    ...
    expectedTools: ['read_note', 'edit_note'],
  },
  {
    id: 'basic_edit_002',
    name: '标记任务完成',
...
export const complexTestCases: TestCase[] = [
  {
    ...
    expectedTools: ['grep_search', 'read_note'],
    expectedPlanSteps: 3,
    evaluationCriteria: [
      '找到所有 TODO 项',
  ...
  },
  {
    ...
    expectedTools: ['list_notes', 'read_note', 'read_outline'],
    expectedPlanSteps: 3,
    evaluationCriteria: [
